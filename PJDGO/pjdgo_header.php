...
<div class="sticky-top shadow">
    ...
    <nav class="navbar navbar-expand-lg navbar-light " style="background-color: rgba(255,255,255,0.9)">
        <a href="../index.php" class="navbar-brand d-block d-lg-none" class="col-xs-1">
            ...
            <div class="linea" style="  width: 100%; height: 3vmin; background-color: #607472; margin-bottom: 2vw;"></div>
        </a>
                ...
                <div class="col-md-3 m-1" id="PJDGO">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0"> 
                            ...
                            <br>
                            <a href="acuerdosTribunal.php" class="dropdown-item"> <span class="material-symbols-outlined"> handshake </span> Acuerdos del Tribunal</a>
                            <br>
                            <a href="acuerdosConsejo.php" class="dropdown-item"><span class="material-symbols-outlined">record_voice_over</span> Acuerdos del Consejo</a>
                            <br>
                            <a href=marcoNormativo.php" class="dropdown-item"><img width="25" height="25" src="https://img.icons8.com/material-outlined/24/scales.png" alt="scales"/> Marco Normativo </a>
                            <br>
                            <a href="estadisticaJudicial.php" class="dropdown-item"><img width="25" height="25" src="https://img.icons8.com/material-outlined/24/bullish.png" alt="bullish"/> Estadistica Judicial</a>
                            <br>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 m-1" id="consultas-frecuentes">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0" > 
                            ...
                            <br>
                            <a href="#" class="dropdown-item"> <span class="material-symbols-outlined">local_police</span>Agenda Audiencias Penales</a>
                            <br>
                            <a href="#" class="dropdown-item"><span class="material-symbols-outlined">record_voice_over</span> Agenda Audiencias Oral Mercantil</a>
                            <br>
                            <a href="#" class="dropdown-item"><span class="material-symbols-outlined">work</span> Licitaciones</a>
                            <br>
                            <a href="#" class="dropdown-item"><span class="material-symbols-outlined">touch_app</span> Convocatorias</a>
                            <br>
                        </div>
                    </div>
                </div>
