...
<div class="sticky-top shadow row" id="navegacion">
<div class="linea" style="  width: 100%; height: 1vmin; background-color: #607472;"></div>
    ...
    <div class="col-lg-12">
        ...
        <div class="mb-2">
            ...
            <nav class="navbar navbar-expand-lg navbar-light " style="background-color: rgba(255,255,255,0.9)">
                ...
                <div class="collapse navbar-collapse row" id="navbarCollapse" style="margin-top: -1vmax;">
