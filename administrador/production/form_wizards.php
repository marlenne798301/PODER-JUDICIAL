          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Formulario de registro <small>Poder Judicial del Estado de Durango</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <div id="step-1">
                        <form class="form-horizontal form-label-left" id="registro">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input type="text" id="first-name" required="required" class="form-control " autofocus>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Puesto/perfil <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                          ...
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Nombre de usuario</label>
                            <div class="col-md-6 col-sm-6 ">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <input id="password" class="form-control col" type="password" name="middle-name"  required="required"> 
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align" >Contraseña</label>
                            <div class="col-md-6 col-sm-6 ">
                              <input id="confirmPassword" class="form-control col" type="password" name="middle-name"  required="required">
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              <div id="gender" class="btn-group" data-toggle="buttons">
                                <label class="btn btn-secondary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-secondary">
                                  <input type="radio" name="gender" value="hombre" class="join-btn"> &nbsp; Hombre &nbsp;
                                </label>
                                <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-secondary">
                                  <input type="radio" name="gender" value="mujer" class="join-btn"> Mujer
                                </label>
                              </div>
                            </div>
                          </div>
